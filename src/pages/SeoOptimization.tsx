  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        <Helmet>
          <title>Optymalizacja SEO – Audyt SEO, pozycjonowanie stron, Google</title>
          <meta name="description" content="Profesjonalna optymalizacja SEO, audyt SEO, pozycjonowanie stron internetowych, poprawa widoczności w Google, skuteczne strategie SEO, pozycjonowanie lokalne i sklepów internetowych." />
