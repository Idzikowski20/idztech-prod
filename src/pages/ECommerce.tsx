  ...
  return (
    <>
      ...
      <div className="min-h-screen ">
        <Helmet>
          <title>Sklepy internetowe – Tworzenie sklepów online, e-commerce, SEO</title>
          <meta name="description" content="Tworzymy nowoczesne sklepy internetowe. E-commerce, WooCommerce, Shopify, audyt SEO, optymalizacja, pozycjonowanie sklepów online i stron internetowych. Zwiększ sprzedaż z IDZTECH!" />
