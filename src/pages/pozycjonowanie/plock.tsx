...
const PlockSeoPage = () => {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 w-full max-w-xl relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                Zamów pozycjonowanie stron plock
              </button>
            </div>
          </div>
          {/* Prawa kolumna */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-14">
            ...
            <div className="bg-white dark:bg-premium-dark/80 rounded-2xl border border-premium-light/30 shadow-lg p-8 transition-all duration-300  relative group">
              ...
              <p className="text-premium-dark dark:text-premium-light mb-4">Kompleksowa strategia SEO i pozycjonowania stron internetowych pozwoli Ci prześcignąć konkurencję na rynku Płocka.</p>
            </div>
            {/* Karta 2 */}
            <div className="bg-white dark:bg-premium-dark/80 rounded-2xl border border-premium-light/30 shadow-lg p-8 transition-all duration-300  relative group">
            <h3 className="text-2xl">Zwiększymy Twój</h3><h3 className="text-2xl font-bold text-premium-purple mb-2">Ruch na stronie www 🔝</h3>
              <p className="text-premium-dark dark:text-premium-light mb-4">Odpowiednie działania SEO i pozycjonowanie strony internetowej ściągną na Twoją stronę www oraz sklep internetowy klientów z Płocka i okolic.</p>
            </div>
            ...
            <div className="md:col-span-2 bg-white dark:bg-premium-dark/80 rounded-2xl border border-premium-light/30 shadow-lg p-6 md:p-10 flex flex-col md:flex-row items-center gap-8">
              ...
              <h3 className="text-2xl">Zwiększymy Twoją</h3><h3 className="text-2xl font-bold text-premium-purple mb-2">Sprzedaż w sklepie internetowym 🔝</h3>
                <p className="text-premium-dark dark:text-premium-light text-base">
                  Wiemy, jakie kroki wykonać, by Twój sklep internetowy i strona internetowa w Płocku generowały większe przychody i rozwijały się z miesiąca na miesiąc dzięki skutecznemu pozycjonowaniu stron SEO.
                </p>
              </div>
            </div>
          </div>
      ...
      <LocalSeoSection />
      <GlobalCTA 
        title="Gotowy na zwiększenie widoczności w Płocku?"
