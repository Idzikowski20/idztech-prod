...
const HERO_IMAGE = "/images/kraków.jpg";
...
const KrakowSeoPage = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Pozycjonowanie Kraków - Skuteczne SEO lokalne | IDZTECH</title>
        <meta name="description" content="Zwiększ widoczność swojej firmy w Krakowie. Skuteczne pozycjonowanie lokalne, które przyciąga klientów z Twojego miasta. Sprawdź ofertę!" />
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 w-full max-w-xl relative">
            ...
            <h1 className="text-2xl md:text-5xl font-bold mb-6 text-premium-dark dark:text-premium-light leading-tight">
              Pozycjonowanie lokalne <span className="text-premium-purple">Kraków</span>
            </h1>
            <p className="text-lg text-premium-light/80 mb-8">
              Zwiększamy widoczność Twojej firmy w Google, pozyskujemy lokalnych klientów i budujemy trwałą obecność Twojej marki w Krakowie.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-10">
            ...
            <p className="text-premium-light/70 text-base max-w-2xl">
              Lata doświadczenia w branży pozwoliły nam wypracować rozwiązania, które są skuteczne i przekładają się na realne wyniki dla firm z Krakowa.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-14">
            ...
            <div className="bg-white dark:bg-premium-dark/80 rounded-2xl border border-premium-light/30 shadow-lg p-8 transition-all duration-300  relative group">
              ...
              <p className="text-premium-dark dark:text-premium-light mb-4">Kompleksowa strategia SEO pozwoli Ci prześcignąć konkurencję na lokalnym rynku Krakowa.</p>
            ...
            <h3 className="text-2xl">Zwiekszymy twój</h3><h3 className="text-2xl font-bold text-premium-purple mb-2">Ruch 🔝</h3>
              <p className="text-premium-dark dark:text-premium-light mb-4">Odpowiednie działania SEO ściągną na Twoją stronę klientów z Krakowa i okolic.</p>
            ...
            <div className="md:col-span-2 bg-white dark:bg-premium-dark/80 rounded-2xl border border-premium-light/30 shadow-lg p-6 md:p-10 flex flex-col md:flex-row items-center gap-8">
              ...
              <h3 className="text-2xl">Zwiekszymy twoją</h3><h3 className="text-2xl font-bold text-premium-purple mb-2">Sprzedaż 🔝</h3>
                <p className="text-premium-dark dark:text-premium-light text-base">
                  Wiemy, jakie kroki wykonać, by Twój biznes w Krakowie generował większe przychody i rozwijał się z miesiąca na miesiąc.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-10">
            ...
            <p className="text-premium-light/70 text-base max-w-2xl">
              Oto, co zyskasz wybierając naszą oferte <span className="text-premium-purple">Pozycjonowanie Kraków</span>.
            </p>
          </div>
      ...
      <section className="mb-12">
        <FAQAccordion
          title="Najczęściej zadawane pytania o pozycjonowanie w Krakowie"
          items={[
            {
              question: 'Czy pozycjonowanie lokalne w Krakowie jest skuteczne?',
      ...
      {/* CTA przed stopką */}
      <GlobalCTA
        title="Gotowy na zwiększenie widoczności w Krakowie?"
