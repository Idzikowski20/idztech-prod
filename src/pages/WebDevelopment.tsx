  ...
  return (
    ...
    >
          ...
          <div className="container mx-auto px-4 lg:px-8 overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="w-full h-full animate-fade-in">
                <span className="text-main font-medium">Web development</span>
                <h1 className="text-4xl lg:text-4xl font-bold mt-4 mb-6 ">
                Tworzymy <mark className="text-main">strony internetowe</mark>, które odpowiadają na potrzeby odbiorców.
                </h1>
                <p className="text-lg mb-8">
                Tworzymy nowoczesne, responsywne i zoptymalizowane strony internetowe, które pomagają osiągać cele biznesowe i wyróżniać się na tle konkurencji.
                </p>
        ...
        <section className="py-16 /50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <p className="text-main font-medium mb-3">Co oferujemy</p>
              ...
              <div className="/60 border border-premium-light/10 rounded-xl p-8 hover:transform hover:scale-105 transition-transform">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <Check size={18} className="text-gradient mr-2 mt-1" />
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <p className="text-main font-medium mb-3">Proces tworzenia</p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <p className="text-main font-medium mb-3">Co otrzymasz</p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <p className="text-main font-medium mb-3">Plan działania</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="/60 border-premium-light/10">
                <CardHeader>
                  <CardTitle className='text-main'>1. Analiza i strategia</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start">
              ...
              <Card className="/60 border-premium-light/10">
                <CardHeader>
                <CardTitle className='text-main'>2. Projektowanie UX/UI</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start">
              ...
              <Card className="/60 border-premium-light/10">
                <CardHeader>
                <CardTitle className='text-main'>3. Implementacja i rozwój</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start">
              ...
              <Card className="/60 border-premium-light/10">
                <CardHeader>
                <CardTitle className='text-main'>4. SEO i treści</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start">
              ...
              <Card className="/60 border-premium-light/10">
                <CardHeader>
                <CardTitle className='text-main'>5. Wdrożenie i testy</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start">
              ...
              <Card className="/60 border-premium-light/10">
                <CardHeader>
                <CardTitle className='text-main'>6. Wsparcie i rozwój</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start">
