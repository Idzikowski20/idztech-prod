    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <section className="py-16 px-4 md:px-8 lg:px-16 container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className="h-14 w-14 bg-wave bg-gradient-to-br from-premium-blue-500 via-premium-purple-500  rounded-full flex items-center justify-center mb-4 group-hover:scale-105 transition-transform duration-300 p-2">
                  {item.icon}
                </div>
        ...
        <GlobalCTA
          ...
          buttons={[
            <Button 
              className="bg-wave from-premium-blue-500 bg-gradient-to-br  via-premium-purple-500  hover:opacity-90 transition-opacity text-white rounded-full px-8 py-6"
